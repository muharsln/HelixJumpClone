...
namespace HelixJump.Ground
{
    public class GroundCreator : MonoBehaviour
    {
        ...
        // Oluþacak ground nesnelerinin parent objesi
        [SerializeField] private Transform _groundParentObject;

        // Oluþturduðumuz objelerin bulunduðu liste
        private List<GameObject> _barObjects = new List<GameObject>();

        // Oluþan ground nesnelerinin yeni pozisyon ve rotasyon deðerlerini tutan deðiþkenler
